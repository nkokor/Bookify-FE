...
export default function LibrariesMap({ libraries, selectedLibrary }) {
  ...
  useEffect(() => {
    if (selectedLibrary && markerRefs.current[selectedLibrary.id]) {
      markerRefs.current[selectedLibrary.id].openPopup();
    }
  }, [selectedLibrary]);
  ...
  return (
    ...
    >
      ...
      />
      <MapController selectedLibrary={selectedLibrary} libraries={libraryLocations} />
